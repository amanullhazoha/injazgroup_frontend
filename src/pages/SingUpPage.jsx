    ...
    return (
        <div className="bg-white grid grid-cols-1 md:grid-cols-9 lg:grid-cols-8 h-screen">
            ...
            <div className="max-md:my-auto md:pt-20 px-5 sm:px-10 lg:px-20 col-span-1 md:col-span-4 lg:col-span-3">
                <p className="text-center text-2xl font-semibold text-[#111928] mb-10">Logo</p>
                ...
                <p className="text-center text-base font-normal text-[#111928]">Already have an account? <Link to="/sign-in" className="font-semibold">Log in</Link></p>
            </div>
        </div>
    );
}
